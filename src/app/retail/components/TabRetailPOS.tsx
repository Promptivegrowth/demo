...
export function TabRetailPOS({ onTabChange }: { onTabChange?: (t: string) => void }) {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-full gap-6 overflow-y-auto lg:overflow-hidden bg-slate-50/30 p-2 rounded-[40px]">
            ...
            <div className="w-full lg:w-[440px] bg-slate-900 rounded-[50px] shadow-2xl flex flex-col overflow-hidden relative border border-white/5 h-[650px] lg:h-full sticky top-0">
                ...
                <div className="p-6 bg-white/5 border-t border-white/10 backdrop-blur-2xl relative z-10 flex-shrink-0">
